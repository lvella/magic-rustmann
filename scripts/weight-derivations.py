...
D = sympy.sympify(2)
e = [
	[0, -1,  1,  0,  0,  1, -1, 1, 2, -sympy.sympify(3)/4, -sympy.sympify(9)/8],
	[0,  0,  0, -1,  1, -1,  1, 1, 2, -sympy.sympify(3)/4, -sympy.sympify(9)/8]
]
w_idx = [0,  1,  2,  1,  2,  3,  3, 4, 5,                   6,                   7]
...
unique_w = list(sympy.symbols(f"w:{max(w_idx)+1}"))
